...
FOR PLAYERS: [**DOWNLOAD LATEST SCENARIO PACK HERE (v1.53)**](https://github.com/musurca/IKE/releases/download/v1.53-scenarios/IKE_Scenario_Pack_v1.53.zip)

FOR SCENARIO AUTHORS: [**DOWNLOAD LATEST RELEASE HERE (v1.53)**](https://github.com/musurca/IKE/releases/download/v1.53/IKE_v1.53.zip)
