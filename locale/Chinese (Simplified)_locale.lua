-- EXPORTED FROM ./locale/Chinese (Simplified)_locale.csv
	...
	["Chinese (Simplified)"] = {
		...
		["SECOND"] = "第2顺位",
		["SEND_CHAT"] = "向哪一方发送消息?\n\n选项: %1",
		["SET_POSTURE"] = "目前你对 %1 阵营的敌对关系是 %2. 是否设置新的敌我关系?\n\n选项: 友好, 中立, 非友好, 敌对",
		["SETUP_PHASE_INTRO"] = "现在是 %1 阵营的设置阶段.\n\n在完成设置挂载和任务之前请务必让游戏保持暂停状态.\n\n当完成布置,请点击Play结束此阶段.",
		["SEVENTH"] = "第7顺位",
		["SHOW_REMAINING_SETUP"] = "现在是布置阶段.",
		["SHOW_REMAINING_TIME"] = "回合剩余时间: %1:%2:%3.",
		["SIXTH"] = "第6顺位",
		["SPEC_CHANGEPOST_DESC"] = "改变敌我关系. 如果你不慎攻击了民间目标，并不想继续与之敌对的话可以这样做.",
		["SPEC_CHANGEPOST_NAME"] = "(邮件对战) 变更敌我关系",
		...
		["THIRD"] = "第3顺位",
		["VERSION_MISMATCH"] = "错误: 您使用的版本为%1, 但当前的对战剧本为 %2. 所有玩家必须使用相同的版本号.",
