-- EXPORTED FROM ./locale/French_locale.csv
	...
	["French"] = {
		...
		["DAMAGE_LISTING"] = "touché par %1",
		["DAMAGES_REPORTED"] = "Unités endommagées:",
		["UNKNOWN_WEAPON"] = "arme inconnue",
		["HIT_LISTING"] = "touché avec %1",
		["HITS_REPORTED"] = "Frappes réussies:",
		["SPEC_PASSCHANGE_NAME"] = "(PBEM) Changer votre mot de passe",
		["SPEC_PASSCHANGE_DESC"] = "Changer votre mot de passe. Utile si vous voulez faire voir votre tour à un autre joueur mais que vous ne voulez pas révéler votre mot de passe habituel.",
		["WIZARD_CONST_TURN_LENGTHS"] = "Utiliser une longueur de tour fixe ? \n\n(AVANCE: Cliquer « No » pour permettre aux joueurs d'alterner entre des durées de tours intermédiaires et tactiques.)",
		["WIZARD_INTERMEDIATE_LENGTH"] = "Entrez la LONGUEUR DE TOUR 'INTERMEDIAIRE' en minutes:",
		["WIZARD_TACTICAL_LENGTH"] = "Entrez la LONGUEUR DE TOUR 'TACTIQUE' en minutes: \n(doit être significativement inférieure à la durée 'intermédiaire')",
		["VARIABLE_TIME_WARNING"] = "Ce scénario utilise des durées de tours variables (intermédiaire vs tactique). Vous pouvez changer la longueur du tour dans le menu « Special Actions ».",
		["SPEC_TACTICAL_NAME"] = "(TEMPS) Commencer en durée tactique (tours de %1 minutes)",
		["SPEC_TACTICAL_DESC"] = "Change la durée du tour en mode « tactique » (%1 minutes), pour un contrôle plus fin de vos unités lors des phases d'action intenses. Cette action ne peut être exécutée qu'au début de votre tour.",
		["SPEC_INTERMEDIATE_NAME"] = "(TEMPS) Offrir d'entrer en tours de durée intermédiaire (tours de %1 minutes)",
		["SPEC_INTERMEDIATE_DESC"] = "Propose de changer la durée d'un tour en « intermédiaire » (%1 minutes), pour une résolution plus rapide des phases de jeu moins intenses. Si l'autre joueur valide ce choix, la durée intermédiaire commencera lors de son tour de jeu.",
		["TACTICAL_SETUP"] = "Vous ne pouvez pas passer en durée de tour tactique pendant la phase de setup.",
		["TACTICAL_NOTSTART"] = "Vous ne pouvez passer en durée de tour tactique qu'au début de votre tour.",
		["TACTICAL_ENTERED"] = "Vous êtes passé en durée de tour tactique. La durée des tours est maintenant de %1 minutes.",
		["TACTICAL_INITIATED"] = "Un autre joueur a initié la durée de tours tactique. Les tours dureront maintenant %1 minutes.",
		["INTERMEDIATE_WILLOFFER"] = "Voulez vous proposer d'entrer en mode de tours de durée intermédiaire ?",
		["INTERMEDIATE_OFFERED"] = "Vous avez proposé d'entrer en tours de durée intermédiaire. L'autre joueur décidera lors de son prochain tour s'il accepte.",
		["INTERMEDIATE_HASOFFER"] = "Un autre joueur souhaite entrer en durée de tours « intermédiaire ». Acceptez vous ? Si OUI, la durée d'un tour passera à %1 minutes.",
		["INTERMEDIATE_ALREADY"] = "Une offre de passer en durée de tours « intermédiaire » a déjà été faite.",
		["INTERMEDIATE_VOTED"] = "Vous avez voté pour entrer en temps intermédiaire. Si le vote passe, la durée intermédiaire commencera lors du tour du joueur qui a voté en dernier.",
		["INTERMEDIATE_DECLINED"] = "Vous avez refusé l'offre de passer en tours de durée intermédiaire.",
		["INTERMEDIATE_ENTERED"] = "Le vote pour entrer en tours de durée intermédiaire est passé. Tous les tours seront maintenant d'une durée de %1 minutes."
	},